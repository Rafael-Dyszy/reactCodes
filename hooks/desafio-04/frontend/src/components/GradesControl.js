...
export default function GradesControl({ grades, onDelete, onPersist }) {
  ...
  const handleActionClcik = (id, type) => {
  ...
  return (
    <div className="container">
      {tableGrades.map(({ id, grades }) => {
        ...
        return (
          <table styles={styles.table} className="striped" key={id}>
            <thead>
              <tr>
                <th style={{ width: '20%' }}>Aluno</th>
                <th style={{ width: '20%' }}>Disciplina</th>
                <th style={{ width: '20%' }}>Avaliaçao</th>
                  ...
                  return (
                    <tr key={id}>
                      ...
                      <td>
                        <div>
                          <Action
                            onActionClick={handleActionClcik}
                            id={id}
            ...
            <tfoot>
              <tr>
                ...
                <td>
                  <span style={gradleStyle}>{finalGrade}</span>
                </td>
              </tr>
            </tfoot>
          </table>
